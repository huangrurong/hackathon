...
"""
usage:
./hackathon/tools/ENV-BUILD hackathon/tools/application/reprove.py \
--manifest manifest-files/hackathon-dev \
--builddir d \
--force \
...
action: the supported action, includes checkout branch.
        ...
        "branch": it will create a new branch for all the repositories under builddir
                  ...
                  For example:
                  - git+https://github.com/changev/hackathon.git
                  + git+https://github.com/changev/hackathon.git#branch/release-1.2.3
...
from repository_operator import RepoOperator
