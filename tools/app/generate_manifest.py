...
The generated new manifest: branch-1.2.3-20191215

usage:
./hackathon/tools/ENV-BUILD hackathon/tools/app/generate_manifest.py \
--branch master \
--date "$date" \
--timezone "+0800" \
--builddir b \
...
date: The commit of each repository are last commit before the date.
      The valid date: current (the commit of each repository are the lastest commit")
                      ...
                      date string, such as: 2019-12-01 00:00:00 (the commit of each repository are the last commit before the date")
...
def parse_command_line(args):
    ...
    parser.add_argument("--date",
                         help="Generate a new manifest with commit before the date, such as: current, yesterday, 2019-12-13 00:00:00",
                         action="store")
